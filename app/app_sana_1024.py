...
def get_args():
    ...
    parser.add_argument("--config", type=str, default="configs\sana_config\1024ms\Sana_1600M_img1024.yaml", help="config")
    parser.add_argument(
        "--model_path",
        nargs="?",
        default="Efficient-Large-Model\Sana_1600M_1024px\checkpoints\Sana_1600M_1024px.pth",
        type=str,
